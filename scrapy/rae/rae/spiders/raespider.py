...
class RaespiderSpider(scrapy.Spider):
    ...
    start_urls = ["https://dle.rae.es/srv/keys?q=zw"]
    ...
    def parse(self, response):
        ...
        if self.current_word == "zz" or self.test_cases == 1000:
        ...
        if self.test_cases<= 1000:
            baseURL = "https://dle.rae.es/srv/keys?q=" + self.current_word
